...
from .models import User, Address, UserRole, Location
# User = get_user_model()
...
class UserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = tuple(User.REQUIRED_FIELDS) + (
            User._meta.pk.name,
            User.USERNAME_FIELD, 'country', 'city', 'first_name', 'last_name', 'avatar',
            'date_joined', 'roles',
        )
...
class UserCreateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = tuple(User.REQUIRED_FIELDS) + (
            User.USERNAME_FIELD, User._meta.pk.name, 'password', 'country', 'city', 'first_name',
            'last_name', 'avatar'
        )
...
class AddressSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Address
        fields = ('id', 'user', 'first_name', 'last_name', 'address1', 'address2', 'city', 'state',  'country',
